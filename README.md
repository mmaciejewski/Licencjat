...
W części praktycznej pracy stworzono dwie wersje gry „The Climb” - po jednej w każdym z silników. Zostały one oparte na jednym Game Design Document (patrz, rozdział 3 –- „Czym jest Game Design Document”). Aby uruchomić gry wystarczy uruchomić pliki exe w folderze z grą.
