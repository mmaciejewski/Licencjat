...
W części praktycznej pracy stworzono dwie wersje gry „The Jump” - po jednej w każdym z silników. Zostały one oparte na jednym Game Design Document (patrz, rozdział 3 –- „Czym jest Game Design Document”). 
