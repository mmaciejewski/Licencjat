...
\source{\href{http://www.benchmark.pl/}{Benchmark}, \href{https://pl.wikipedia.org}{Wikipedia} }
\end{table}
...
Teraz kiedy już nasza postać wykrywa ściany do wspinaczki możemy zająć się chwytaniem krawędzi. Na początek stwórzmy nowy interfejs. Aby to zrobić, w menu kontekstowym (w lewym dolnym rogu) klikamy przycisk „Add New", następnie rozwijamy „Bueprints" i wybieramy „Blueprint interface". Nazwijmy go "CharMoveInterface" i od razu go otwórzmy.
...
Po raz kolejny wracamy do „ThirdPerson$\_$AnimBP", tym razem przechodzimy do Animacji Grafu. Tam klikamy prawym przyciskiem myszy na tło i wybieramy „Add state...". Nasz nowy stan możemy nazwać „LedgeGrab". Klikamy na niego dwukrotnie, aby dodać animacje. Wystarczy, że 
